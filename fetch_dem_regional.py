        ...
        with urllib.request.urlopen(req) as response:
            ...
            for py in range(TILE_SIZE):
                for px in range(TILE_SIZE):
                    ...
                    if elev < 0: elev = 0
                    gray = min(255, int(elev / 3000.0 * 255)) # Scale up to 3000m since cascades go higher
...
print("Top Left:", tile2latlon(X_START, Y_START, Z))
print("Bottom Right:", tile2latlon(X_START + COLS, Y_START + ROWS, Z))
