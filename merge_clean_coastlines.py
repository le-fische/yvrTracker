...
# 2. Load the Overpass chunks and FILTER
...
for way in osm_ways_geo:
    # FILTER: Only keep major waterways/coastlines, removing noise
    if len(way) > 50:
...
print(f"Merged {len(cv_ways)} CV contours and {len(osm_ways)} cleaned OSM vectors.")
